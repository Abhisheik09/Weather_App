...
const dom = (function () {
  function show(value) {
    ...
    mainElement.style.display = value === 'search' ? 'none' : 'block';
    sectionElement.style.display = value === 'search' ? 'block' : 'none';
    section2Element.style.display = value === 'forecast' ? 'block' : 'none';
  }

  function fillCard(data) {
    const addInnerText = helpers().addInnerText;
  ...
  function imageSwitch(data, id) {
    ...
    switch (true) {
      case code >= 200 && code <= 232:
        element.style.backgroundImage = "url('../src/images/lighting.jpg')";
        break;
      case code >= 300 && code <= 321:
        element.style.backgroundImage = "url('../src/images/drizzle.jpg')";
        break;
      case code >= 500 && code <= 531:
        element.style.backgroundImage = "url('../src/images/rain.jpg')";
        break;
      case code >= 600 && code <= 622:
        element.style.backgroundImage = "url('../src/images/snow.jpg')";
        break;
      case code >= 701 && code <= 781:
        element.style.backgroundImage = "url('../src/images/mist.jpg')";
        break;
      case code >= 801 && code <= 804:
        element.style.backgroundImage = "url('../src/images/rainclouds.jpg')";
        break;
      case code === 800:
        element.style.backgroundImage = "url('../src/images/shiningsun.jpg')";
        break;
      default:
        element.style.backgroundImage = "url('../src/images/bluesky.jpg')";
        break;
    }
  }
